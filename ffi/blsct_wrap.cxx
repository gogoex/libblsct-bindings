...
static SwigV8ReturnValue _wrap_blsct_decode_address(const SwigV8Arguments &args) {
  ...
  if (args.Length() < 2 || args.Length() > 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_blsct_decode_address.");
  
  res1 = SWIG_AsCharPtrAndSize(args[0], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "blsct_decode_address" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);res2 = SWIG_ConvertPtr(args[1], &argp2,SWIGTYPE_p_unsigned_char, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "blsct_decode_address" "', argument " "2"" of type '" "uint8_t [ENCODED_DPK_SIZE]""'"); 
  } 
  arg2 = reinterpret_cast< uint8_t * >(argp2);result = (bool)blsct_decode_address((char const *)arg1,arg2);
...
static SwigV8ReturnValue _wrap_blsct_encode_address(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_VALUE jsresult;
  uint8_t *arg1 = (uint8_t *) (uint8_t *)0 ;
  char *arg2 = (char *) 0 ;
  enum AddressEncoding arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int res2 ;
  char *buf2 = 0 ;
  ...
  if (args.Length() < 3 || args.Length() > 3) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_blsct_encode_address.");
  
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_unsigned_char, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "blsct_encode_address" "', argument " "1"" of type '" "uint8_t const [ENCODED_DPK_SIZE]""'"); 
  } 
  arg1 = reinterpret_cast< uint8_t * >(argp1);res2 = SWIG_AsCharPtrAndSize(args[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "blsct_encode_address" "', argument " "2"" of type '" "char *""'");
  }
  arg2 = reinterpret_cast< char * >(buf2);ecode3 = SWIG_AsVal_int(args[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "blsct_encode_address" "', argument " "3"" of type '" "enum AddressEncoding""'");
  } 
  arg3 = static_cast< enum AddressEncoding >(val3);result = (bool)blsct_encode_address((unsigned char const (*))arg1,arg2,arg3);
  jsresult = SWIG_From_bool(static_cast< bool >(result));
...
NODE_MODULE(libblsct, libblsct_initialize)
#else
NODE_MODULE_CONTEXT_AWARE(libblsct, libblsct_initialize)
#endif
#endif
